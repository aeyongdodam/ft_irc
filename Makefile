...
SRCS	+=	command/pass.cpp command/nick.cpp command/user.cpp command/privmsg.cpp command/kick.cpp command/join.cpp command/part.cpp command/topic.cpp command/mode.cpp command/quit.cpp command/util.cpp
OBJS	=	$(SRCS:%.cpp=%.o)
